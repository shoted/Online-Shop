...
namespace Shop.BLL 
{
	public partial class FocusProductsBLL
	{
   		     
		/// <summary>
        /// 数据库操作对象
        /// </summary>
        private FocusProductsDAL _dao = new FocusProductsDAL();
        ...
        {
            return _dao.Delete(focusproductid);
        }
        #endregion
        ...
        {
            return _dao.QuerySingle(focusproductid);
        }
        #endregion
