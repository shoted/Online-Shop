...
namespace Itcast.Mall.Utility
{
    ...
    {
        private readonly static string SmtpServer = "smtp-mail.outlook.com";
        private readonly static int SmtpServerPort = 25;
        private readonly static bool SmtpEnableSsl = true;
        private readonly static string SmtpUsername = "shoted@outlook.com";
        private readonly static string SmtpDisplayName = "常在河边走";
        private readonly static string SmtpPassword = "a12345..";
